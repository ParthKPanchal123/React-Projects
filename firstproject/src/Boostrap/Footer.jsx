        ...
        <div className="container">
            <div className="row">
                <div className="col-md-6 mt-md-0 mt-3">
                    <h5 className="text-uppercase">Parth</h5>
                    <li style={{ listStyle: "none", background: "White" }}>Email:-hello@gmail.com</li>
                    <li style={{ listStyle: "none", background: "White" }}>Phone:-0803333333</li>
                </div>
